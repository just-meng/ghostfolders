...
python 02_code/rename.py {inputs} "2023-07-27" "2023-07-28"
"""
...
parser.add_argument('inputs', help='{inputs}')
parser.add_argument('match', help='expression')
parser.add_argument('replace_by', help='expression')
...
[os.replace(os.path.join(directory, old), os.path.join(directory, new)) for (old, new) in zip(old_file_names, new_file_names)]